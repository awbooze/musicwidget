...
public class StandardWidget extends AppWidgetProvider {
    ...
    public void updateAppWidget(Context context, AppWidgetManager appWidgetManager,int appWidgetId) {
        ...
        if(!isTall&&currentArt==null) {
            ...
            remoteView.setViewVisibility(R.id.albumArt, View.VISIBLE);
        }
        ...
        if(currentSong.equals("")) {
            ...
            remoteView.setViewVisibility(R.id.song, View.VISIBLE);
        }
        if(currentArtist.equals("")) {
            remoteView.setViewVisibility(R.id.artist,View.GONE);
        }
        else {
            remoteView.setViewVisibility(R.id.artist,View.VISIBLE);
        }
        if(!p.getBoolean("showAlbum",false) || currentAlbum.equals("")) {
            remoteView.setViewVisibility(R.id.album, View.GONE);
        }
        else {
            remoteView.setViewVisibility(R.id.album,View.VISIBLE);
        }

        remoteView.setTextViewText(R.id.artist, new SpannableStringBuilder(Html.fromHtml(artistString)));
        remoteView.setTextViewTextSize(R.id.artist, TypedValue.COMPLEX_UNIT_SP,p.getInt("artistSize",2)*2+10);
        remoteView.setTextViewText(R.id.album, new SpannableStringBuilder(Html.fromHtml(albumString)));
        ...
        remoteView.setTextViewText(R.id.song, new SpannableStringBuilder(Html.fromHtml(songString)));
		...
		if(currentArt != null && isTall) {
		    ...
		    remoteView.setImageViewUri(R.id.albumArt, Uri.parse(""));
        }
